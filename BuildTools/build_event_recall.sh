...
unityScriptDir="${rootDir}/../../Hotel1/Assets/Scripts/Event/Recall/Config"
...
spreadsheet_id="1ttXoeF0VKeGos6Zhf-q-1ZiT6SX-v2jpxnqAQWJG6-E"
...
nameSpace="Recall"
jsonPath="Configs/EventRecallConfig/eventrecall"
