...
spreadsheet_id="1ej4b1D9jezEvhXSlDjafy45ND4K1Me3oS9Y7gJBg5VU"
...
jsonDataDir="${rootDir}/../../Cooking1/Assets/Res/Configs/BonusLevelConfig/"
fileName="bonuslevelconfig"
autoConfigDir="${rootDir}/../../Cooking1/Assets/Res/Configs/Exportconfig"
...
python convert_bonus_level.py -r ${autoConfigDir}
# pause
