...
spreadsheet_id="1yVQL-CMYffAnff_AdMnJ8HAQd-oKq0jBefL4FAUlOuc"
...
jsonDataDir="${rootDir}/../../Hotel1/Assets/Export/Configs/GalleryActivityConfig/"
fileName="galleryactivity"
