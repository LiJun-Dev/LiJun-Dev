...
var Builder = require('./BuilderLocale');
var OAuth2Config = require('../oauth2.json');
var google = require('googleapis');

program
    .version('0.0.1')
    .usage('<decoSheet-id> <unity-script-dir> <json-data-dir> [options]')
...
oauth2Client.getAccessToken(function(err, token) 
{
    ...
    } else 
    {
        decoSheet = GoogleSpreadsheet({
            ...
            outputConfig = new Builder.OutputConfig(program.args[1], program.args[2], "", "");
