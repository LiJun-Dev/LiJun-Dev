...
function readsheetOAuth2(worksheets, idxSheet, countSheet) {
    ...
    worksheets[idxSheet].cells(null, function(err, cells) {
        ...
        var defaultValues = rows[3].reduce(function(defaultValues, cell) {
            if (cell.value === "") {
        ...
        var others = rows[4].reduce(function(others, cell) {
            if (cell.value === "") {
                return others;
            }
        ...
        var gssClass = new Builder.GssClass(sheetName, properties, valueTypes, descriptions, defaultValues, others);
